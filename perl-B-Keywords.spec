...
Version  : 1.23
Release  : 23
URL      : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/B-Keywords-1.23.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/B-Keywords-1.23.tar.gz
...
%prep
%setup -q -n B-Keywords-1.23
cd %{_builddir}/B-Keywords-1.23
...
cp %{_builddir}/B-Keywords-1.23/LICENSE %{buildroot}/usr/share/package-licenses/perl-B-Keywords/0e987cce2b4e94a4d6920e7353f8674a4462528a
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/B/Keywords.pm
