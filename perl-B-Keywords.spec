...
%prep
%setup -q -n B-Keywords-1.22
cd %{_builddir}/B-Keywords-1.22
...
cp %{_builddir}/B-Keywords-1.22/LICENSE %{buildroot}/usr/share/package-licenses/perl-B-Keywords/0e987cce2b4e94a4d6920e7353f8674a4462528a
if test -f Makefile.PL; then
