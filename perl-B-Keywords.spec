...
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/B-Keywords-1.20.tar.gz
...
%prep
%setup -q -n B-Keywords-1.20
cd ..
%setup -q -T -D -n B-Keywords-1.20 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/B-Keywords-1.20/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.1/B/Keywords.pm
