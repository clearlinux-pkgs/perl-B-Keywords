...
Version  : 1.27
Release  : 34
URL      : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/B-Keywords-1.27.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/B-Keywords-1.27.tar.gz
...
%prep
%setup -q -n B-Keywords-1.27
cd %{_builddir}/B-Keywords-1.27
pushd ..
cp -a B-Keywords-1.27 buildavx2
popd
...
cp %{_builddir}/B-Keywords-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-B-Keywords/0e987cce2b4e94a4d6920e7353f8674a4462528a || :
if test -f Makefile.PL; then
