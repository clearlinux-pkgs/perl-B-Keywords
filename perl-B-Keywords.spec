...
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/B-Keywords-1.26.tar.gz
...
%prep
%setup -q -n B-Keywords-1.26
cd %{_builddir}/B-Keywords-1.26
pushd ..
cp -a B-Keywords-1.26 buildavx2
popd
